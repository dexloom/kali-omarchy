-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
-- KALI-HYPRLAND — working Hyprland config                --
--                                                        --
-- Deployed to ~/.config/hypr/hyprland.lua by             --
-- 11-omarchy4-deploy.sh, which also appends the          --
-- require("omarchy4") block at the end of this file.     --
--                                                        --
-- Project rule: LUA ONLY. Never add a hyprland.conf —    --
-- Hyprland prefers .conf and it would silently shadow    --
-- this file.                                             --
--                                                        --
-- Every hl.bind carries a `description`: Hyprland        --
-- reports Lua binds as dispatcher __lua, and             --
-- omarchy-menu-keybindings drops any __lua bind without  --
-- one. No description = invisible in the keybindings     --
-- menu. lib/add-bind-descriptions.py maintains these.    --
--                                                        --
-- Upstream template: /usr/share/hypr/hyprland.lua        --
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
...
local terminal    = "omarchy-launch-terminal"  -- honours ~/.config/xdg-terminals.list (qterminal)
local fileManager = "dolphin"
local menu        = "omarchy-menu summon apps"  -- hyprlauncher is not packaged for Kali
...
hl.bind(mainMod .. " + J", hl.dsp.layout("togglesplit"), { description = "Toggle window split" })    -- dwindle only
...
-- Scroll-wheel resize and ALT workspace scrolling live in omarchy4.lua,
-- which loads after this file. Defining them here too would register
-- the same combo twice.


-- Move/resize windows with mainMod + LMB/RMB and dragging
hl.bind(mainMod .. " + mouse:272", hl.dsp.window.drag(), { mouse = true, description = "Move window" })
-- SUPER + mouse:273 (right-drag resize) removed: on a touchpad that is a
-- two-finger click-and-hold and did not work reliably. Resize via a window
-- edge, SUPER+SHIFT+left-drag, SUPER + -/=, or the touchpad gestures.
